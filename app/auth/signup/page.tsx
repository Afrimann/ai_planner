...
function getStrengthMeta(password: string) {
  ...
  if (score <= 2) return { score, label: "Weak", barClass: "bg-zinc-400", rules };
  if (score <= 3) return { score, label: "Fair", barClass: "bg-zinc-600", rules };
  if (score === 4) return { score, label: "Strong", barClass: "bg-zinc-800", rules };
  return { score, label: "Excellent", barClass: "bg-black", rules };
}
